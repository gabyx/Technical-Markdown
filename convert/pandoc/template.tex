...
% }{%
%     \colorlet{myurlcolor}{white!50!black}%
...
% % only if xelatex, nomath because of accent package
...
% % Hyphenation specials
% \babelhyphenation[british]{oc-cu-pa-tion-spe-cif-ic}
