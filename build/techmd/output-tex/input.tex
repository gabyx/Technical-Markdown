...
\edef\input@path{{/Volumes/Data/Repositories/technicalmarkdown/tools/convert/includes}{/Volumes/Data/Repositories/technicalmarkdown/src/techmd}{./}\input@path}% prepend
\makeatother
